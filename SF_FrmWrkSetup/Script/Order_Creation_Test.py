...
def Order_Creation_Test():
 for i in range(2,3):
    ...
    aqObject.CheckProperty(Aliases.browser.pageAllSalesOrdersFinanceAndOper.textnodeLines.buttonGeneral.textboxAfterTheLookupIsOpenYou, "Text", cmpEqual, account)